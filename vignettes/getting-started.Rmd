...
Once the API Token has been intialized, you can begin to use the package. However before you can pull data from a individual team, you must pull that Team ID and Update your token with it.
